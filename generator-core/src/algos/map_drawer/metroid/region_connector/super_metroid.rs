...
pub(super) struct SuperMetroidRegionConnectorDrawer;

impl RegionConnectorDrawer for SuperMetroidRegionConnectorDrawer {
...
impl SuperMetroidRegionConnectorDrawer {
